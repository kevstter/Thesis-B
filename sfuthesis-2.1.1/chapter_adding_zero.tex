...
\caption[Time evolution of the solution to \cref{ammc}.]{Time evolution of the solution to \cref{ammc}. The black curve is the initial state. The bottom gray dashed curve is the state at $T=0.35$.}
\label{fig:ammc sol}
\end{figure}
...
As demonstrated in Duchemin and Eggers \cite{duchemin2014explicit} as well as an earlier paper by Smereka \cite{smereka2003semi}, an efficient method to handling \eqref{ammc} is to add and subtract a linear Laplacian term to the right-hand side, 
\begin{align}

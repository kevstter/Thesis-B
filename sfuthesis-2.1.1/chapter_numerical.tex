...
On the other hand, the ETDRK schemes and the EIN method appears to do well at 50-100 time steps. Recall that these are the schemes that had strong damping at infinity (see \cref{fig:damp fac at inf}). Zoom-ins to the solution by these schemes are provided in \cref{fig:mcm zoom in 1,fig:mcm zoom in 2}. The zoom-ins show that the ETDRK schemes converge nicely with few time steps. The EIN method, however, is again hampered by slow convergence. 
...
\caption[{A zoom-in over $(x,y)\in [0.0,0.2]\times [0.475,0.54]$ to inspect convergence.}]{A zoom-in over $(x,y)\in [0.0, 0.2]\times [0.475, 0.54]$. From top to bottom we have the EIN method, ETDRK2, and ETDRK4. We see slow convergence of the EIN method, and good convergence of the ETDRK schemes.}
...
\begin{minipage}{0.31\textwidth}
        \includegraphics[width=0.94\textwidth]{ein_zoom2}
\end{minipage}
\begin{minipage}{0.31\textwidth}
        \includegraphics[width=0.94\textwidth]{erk2_zoom2}
\end{minipage}
\begin{minipage}{0.31\textwidth}
        \includegraphics[width=0.94\textwidth]{erk4_zoom2}
\end{minipage}
\caption[{A zoom-in over $(x,y) \in [1.3,1.41]\times [0.0, 0.3]$ to inspect convergence.}]{A zoom-in over $(x,y) \in [1.3,1.41]\times [0.0, 0.3]$. We see slow convergence of the EIN method, and good convergence of the ETDRK schemes.}
\label{fig:mcm zoom in 2}
\end{figure}

\subsection{Anisotropic mean curvature motion}
So far, what has been discuss can be more accurately described as isotropic mean curvature motion. In \cite{oberman2011aniso},
